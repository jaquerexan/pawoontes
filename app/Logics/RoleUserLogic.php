...
use Auth;
use App\Queries\RoleUserQuery;

class RoleUserLogic extends RoleUserQuery
{
	/**
	...
	/**
	 * [getUserAssignedRole description]
	 * @param  [type] $id [description]
	 * @return [type]     [description]
	 */
	public function getUserAssignedRole($id)
	{
		return $this->userAssignedRole($id);
	}
}
